...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fastkml-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8680&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fastkml-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fastkml` can be installed with:

```
conda install fastkml
```

It is possible to list all of the versions of `fastkml` available on your platform with:
